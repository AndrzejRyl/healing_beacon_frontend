...
public class PrescribedDrugListAdapter extends ArrayAdapter<PrescribedDrug> {
    public PrescribedDrugListAdapter(Context context, List<PrescribedDrug> objects) {
