...
public class TemperatureMeasurementAddTask extends AsyncTask<Long, Void, PatientCard> {
    ...
    public TemperatureMeasurementAddTask(PatientCardResponseListener listener) {
